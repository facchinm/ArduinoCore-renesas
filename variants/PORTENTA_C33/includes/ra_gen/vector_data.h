...
#define VECTOR_NUMBER_CAN0_COMFRX ((IRQn_Type) 2) /* CAN0 COMFRX (Common FIFO recieve interrupt) */
#define CAN0_COMFRX_IRQn          ((IRQn_Type) 2) /* CAN0 COMFRX (Common FIFO recieve interrupt) */
...
#define VECTOR_NUMBER_SSI0_TXI ((IRQn_Type) 11) /* SSI0 TXI (Transmit data empty) */
#define SSI0_TXI_IRQn          ((IRQn_Type) 11) /* SSI0 TXI (Transmit data empty) */
...
#define VECTOR_NUMBER_SCI0_ERI ((IRQn_Type) 14) /* SCI0 ERI (Receive error) */
#define SCI0_ERI_IRQn          ((IRQn_Type) 14) /* SCI0 ERI (Receive error) */
#define VECTOR_NUMBER_SPI0_RXI ((IRQn_Type) 15) /* SPI0 RXI (Receive buffer full) */
#define SPI0_RXI_IRQn          ((IRQn_Type) 15) /* SPI0 RXI (Receive buffer full) */
#define VECTOR_NUMBER_SPI0_TXI ((IRQn_Type) 16) /* SPI0 TXI (Transmit buffer empty) */
#define SPI0_TXI_IRQn          ((IRQn_Type) 16) /* SPI0 TXI (Transmit buffer empty) */
#define VECTOR_NUMBER_SPI0_TEI ((IRQn_Type) 17) /* SPI0 TEI (Transmission complete event) */
#define SPI0_TEI_IRQn          ((IRQn_Type) 17) /* SPI0 TEI (Transmission complete event) */
#define VECTOR_NUMBER_SPI0_ERI ((IRQn_Type) 18) /* SPI0 ERI (Error) */
#define SPI0_ERI_IRQn          ((IRQn_Type) 18) /* SPI0 ERI (Error) */
...
#define VECTOR_NUMBER_USBFS_FIFO_0 ((IRQn_Type) 21) /* USBFS FIFO 0 (DMA transfer request 0) */
#define USBFS_FIFO_0_IRQn          ((IRQn_Type) 21) /* USBFS FIFO 0 (DMA transfer request 0) */
#define VECTOR_NUMBER_USBFS_FIFO_1 ((IRQn_Type) 22) /* USBFS FIFO 1 (DMA transfer request 1) */
#define USBFS_FIFO_1_IRQn          ((IRQn_Type) 22) /* USBFS FIFO 1 (DMA transfer request 1) */
...
#define VECTOR_NUMBER_ICU_IRQ0 ((IRQn_Type) 26) /* ICU IRQ0 (External pin interrupt 0) */
#define ICU_IRQ0_IRQn          ((IRQn_Type) 26) /* ICU IRQ0 (External pin interrupt 0) */
#define VECTOR_NUMBER_RTC_CARRY ((IRQn_Type) 27) /* RTC CARRY (Carry interrupt) */
#define RTC_CARRY_IRQn          ((IRQn_Type) 27) /* RTC CARRY (Carry interrupt) */
#define VECTOR_NUMBER_EDMAC0_EINT ((IRQn_Type) 28) /* EDMAC0 EINT (EDMAC 0 interrupt) */
#define EDMAC0_EINT_IRQn          ((IRQn_Type) 28) /* EDMAC0 EINT (EDMAC 0 interrupt) */
