...
#define BSP_CFG_PL2ODIVP (BSP_CLOCKS_PLL_DIV_16) /* PLL2P Div /16 */
#define BSP_CFG_PLL2P_FREQUENCY_HZ (60000000) /* PLL2P 60000000Hz */
#define BSP_CFG_PL2ODIVQ (BSP_CLOCKS_PLL_DIV_8) /* PLL2Q Div /8 */
#define BSP_CFG_PLL2Q_FREQUENCY_HZ (120000000) /* PLL2Q 120000000Hz */
...
#define BSP_CFG_I3CCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL1P) /* I3CCLK Src: PLL1P */
#define BSP_CFG_UCK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL2R) /* UCK Src: PLL2R */
#define BSP_CFG_U60CK_SOURCE (BSP_CLOCKS_CLOCK_DISABLED) /* U60CK Disabled */
#define BSP_CFG_OCTA_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL2Q) /* OCTASPICLK Src: PLL2Q */
...
#define BSP_CFG_UCK_DIV (BSP_CLOCKS_USB_CLOCK_DIV_4) /* UCK Div /4 */
#define BSP_CFG_U60CK_DIV (BSP_CLOCKS_USB60_CLOCK_DIV_8) /* U60CK Div /8 */
