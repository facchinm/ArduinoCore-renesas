...
#define VECTOR_NUMBER_CAN0_COMFRX ((IRQn_Type) 3) /* CAN0 COMFRX (Common FIFO recieve interrupt) */
#define CAN0_COMFRX_IRQn          ((IRQn_Type) 3) /* CAN0 COMFRX (Common FIFO recieve interrupt) */
...
#define VECTOR_NUMBER_CAN_RXF ((IRQn_Type) 5) /* CAN RXF (Global recieve FIFO interrupt) */
#define CAN_RXF_IRQn          ((IRQn_Type) 5) /* CAN RXF (Global recieve FIFO interrupt) */
...
#define VECTOR_NUMBER_ICU_IRQ0 ((IRQn_Type) 12) /* ICU IRQ0 (External pin interrupt 0) */
#define ICU_IRQ0_IRQn          ((IRQn_Type) 12) /* ICU IRQ0 (External pin interrupt 0) */
#define VECTOR_NUMBER_SSI0_TXI ((IRQn_Type) 13) /* SSI0 TXI (Transmit data empty) */
#define SSI0_TXI_IRQn          ((IRQn_Type) 13) /* SSI0 TXI (Transmit data empty) */
#define VECTOR_NUMBER_SSI0_INT ((IRQn_Type) 14) /* SSI0 INT (Error interrupt) */
#define SSI0_INT_IRQn          ((IRQn_Type) 14) /* SSI0 INT (Error interrupt) */
#define VECTOR_NUMBER_I3C0_RCV_STATUS ((IRQn_Type) 15) /* I3C0 RCV STATUS (Receive status buffer full) */
#define I3C0_RCV_STATUS_IRQn          ((IRQn_Type) 15) /* I3C0 RCV STATUS (Receive status buffer full) */
#define VECTOR_NUMBER_I3C0_RESPONSE ((IRQn_Type) 16) /* I3C0 RESPONSE (Response status buffer full) */
#define I3C0_RESPONSE_IRQn          ((IRQn_Type) 16) /* I3C0 RESPONSE (Response status buffer full) */
#define VECTOR_NUMBER_I3C0_RX ((IRQn_Type) 17) /* I3C0 RX (Receive) */
#define I3C0_RX_IRQn          ((IRQn_Type) 17) /* I3C0 RX (Receive) */
#define VECTOR_NUMBER_I3C0_TX ((IRQn_Type) 18) /* I3C0 TX (Transmit) */
#define I3C0_TX_IRQn          ((IRQn_Type) 18) /* I3C0 TX (Transmit) */
#define VECTOR_NUMBER_I3C0_IBI ((IRQn_Type) 19) /* I3C0 IBI (IBI status buffer full) */
#define I3C0_IBI_IRQn          ((IRQn_Type) 19) /* I3C0 IBI (IBI status buffer full) */
#define VECTOR_NUMBER_I3C0_EEI ((IRQn_Type) 20) /* I3C0 EEI (Error) */
#define I3C0_EEI_IRQn          ((IRQn_Type) 20) /* I3C0 EEI (Error) */
#define VECTOR_NUMBER_SCI0_RXI ((IRQn_Type) 21) /* SCI0 RXI (Receive data full) */
#define SCI0_RXI_IRQn          ((IRQn_Type) 21) /* SCI0 RXI (Receive data full) */
#define VECTOR_NUMBER_SCI0_ERI ((IRQn_Type) 22) /* SCI0 ERI (Receive error) */
#define SCI0_ERI_IRQn          ((IRQn_Type) 22) /* SCI0 ERI (Receive error) */
#define VECTOR_NUMBER_SPI0_RXI ((IRQn_Type) 23) /* SPI0 RXI (Receive buffer full) */
#define SPI0_RXI_IRQn          ((IRQn_Type) 23) /* SPI0 RXI (Receive buffer full) */
#define VECTOR_NUMBER_SPI0_TXI ((IRQn_Type) 24) /* SPI0 TXI (Transmit buffer empty) */
#define SPI0_TXI_IRQn          ((IRQn_Type) 24) /* SPI0 TXI (Transmit buffer empty) */
#define VECTOR_NUMBER_SPI0_TEI ((IRQn_Type) 25) /* SPI0 TEI (Transmission complete event) */
#define SPI0_TEI_IRQn          ((IRQn_Type) 25) /* SPI0 TEI (Transmission complete event) */
#define VECTOR_NUMBER_SPI0_ERI ((IRQn_Type) 26) /* SPI0 ERI (Error) */
#define SPI0_ERI_IRQn          ((IRQn_Type) 26) /* SPI0 ERI (Error) */
#define VECTOR_NUMBER_CEU_CEUI ((IRQn_Type) 27) /* CEU CEUI (CEU interrupt) */
#define CEU_CEUI_IRQn          ((IRQn_Type) 27) /* CEU CEUI (CEU interrupt) */
#define VECTOR_NUMBER_DRW_INT ((IRQn_Type) 28) /* DRW INT (DRW interrupt) */
#define DRW_INT_IRQn          ((IRQn_Type) 28) /* DRW INT (DRW interrupt) */
#define VECTOR_NUMBER_GLCDC_LINE_DETECT ((IRQn_Type) 29) /* GLCDC LINE DETECT (Specified line) */
#define GLCDC_LINE_DETECT_IRQn          ((IRQn_Type) 29) /* GLCDC LINE DETECT (Specified line) */
#define VECTOR_NUMBER_EDMAC0_EINT ((IRQn_Type) 30) /* EDMAC0 EINT (EDMAC 0 interrupt) */
#define EDMAC0_EINT_IRQn          ((IRQn_Type) 30) /* EDMAC0 EINT (EDMAC 0 interrupt) */
